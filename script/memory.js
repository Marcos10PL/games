$(document).ready(function() 
{
	...
	$('.board').on('click', 'div.field i', function() 
	{
		...
		if(visible.length == 2)
		{
			...
			if(visible[0] == visible[1])
			{
				...
				$(`i.${visible[0]}, i.${visible[1]}`).delay(600).fadeTo(500, 0);
	...
	const back = () =>
	{
		...
		if (pairs == fields.length/2) {
			$('header > div').html('Koniec gry!');
			$('main').html(`<p>Gratulacje, odnalazłeś wszystkie pary w ${trials} ruchach.</p> Aby zagrać ponownie kliknij <a href="./">tutaj</a>`)
